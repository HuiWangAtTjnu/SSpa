...
def generate_question_(data_type, algo, shot):
    if data_type == 1:
        dataset_name = 'dataset1_ada_edu'
    elif data_type == 2:
        dataset_name = 'dataset1_tourism_traffic'
    elif data_type == 3:
        dataset_name = 'dataset2_ada_edu'
    elif data_type == 4:
        dataset_name = 'dataset2_tourism_traffic'
    else:
...
if __name__ == '__main__':
    algos = ['sspa', 'dail_sql', 'sspa_tips', 'sspa_sdbms', 'sspa_geo']
    data_types = [1, 2, 3, 4]
    shots = [0, 1, 3, 5]
    for algo in algos:
        for data_type in data_types:
            for shot in shots:
                generate_question_(data_type, algo, shot)
    #
    print('Finished~')
